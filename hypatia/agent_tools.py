...
TOOLS: list[Tool] = [
    ...
    Tool("cards_export", "Export a deck as JSON with scheduling fields. Keywords: exportar mazo, copia de tarjetas.\nExport every card of a deck as JSON, with its scheduling fields, for the user to keep or move to another machine.\nSinónimos: exportar mazo, descargar tarjetas, copia de seguridad.", CardsExportArgs, _ann(True), run_cards_export),
    Tool("cards_suggest", "Draft flashcards from text or a transcript (nothing saved). Keywords: proponer tarjetas, borradores, sugerir.\nDraft flashcards (proposal, nothing saved) from pasted text or a Scribe's Hoard transcript, with a local model. Returns `drafts` to show the user, or (no model available) `material` for the assistant to draft from itself.\nSinónimos: sugerir tarjetas, tarjetas de la reunión, tarjetas de lo que hablamos, tarjetas de la transcripción, propón tarjetas.", CardsSuggestArgs, _ann(False, False, False), run_cards_suggest),
